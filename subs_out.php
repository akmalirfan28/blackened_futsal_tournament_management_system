...
<header>
  ...
  <div class="table-container">
    ...
    <h2>Substitute Out - Team A</h2><br>
    <table>
      <thead>
        <tr>
          <th>Name</th>
        ...
        while($data = mysqli_fetch_array($records_teamA))
        {
          ?>
            <tr>
                ...
                <td><a href="subs_in.php?match_id=<?php echo $matchID;?>&player_out_id=<?php echo $data['playerID'];?>&team_id=<?php echo $teamA_id;?>"><button class="btn btn-sm">Out</button></a></td>
            </tr>
          <?php
        }
        ?>
    ...
    <h2>Substitute Out - Team B</h2><br>
    <table>
      <thead>
        <tr>
          <th>Name</th>
      ...
      <?php
        ...
        while($data = mysqli_fetch_array($records_teamB))
        {
          ?>
            <tr>
                <td><?php echo $data['name'];?></td>
                <td><a href="subs_in.php?match_id=<?php echo $matchID;?>&player_out_id=<?php echo $data['playerID'];?>&team_id=<?php echo $teamB_id;?>"><button class="btn btn-sm">Out</button></a></td>
            </tr>
          <?php
        }
        ?>
