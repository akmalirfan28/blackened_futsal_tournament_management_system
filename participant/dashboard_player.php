...
<body>
  <div class="container">
    <h2>Dashboard</h2>
    <div class="cards">
      <a href="player_register.php" class="card" style="background: DodgerBlue;">
        <span class="material-symbols-outlined">groups</span>
        <p>Players</p>
      </a>

      <a href="schedule_player.php" class="card" style="background: Tomato;">
        <span class="material-symbols-outlined">calendar_month</span>
        <p>Schedule</p>
      </a>

      <a href="match_score_player.php" class="card" style="background: MediumSeaGreen;">
