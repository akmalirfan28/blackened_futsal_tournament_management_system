...
<body>
    <div class="container">
        <h2>Dashboard</h2>
        <a href="player_register.php">
        <div class="card" style="background: DodgerBlue;">
            <span class="material-symbols-outlined" style="font-size: 2rem;"> groups <p>Players</p></span>
            </div></a><br>

            <a href="schedule_player.php">
