...
<header>
  ...
  <aside class="sidebar">
    ...
    <ul class="sidebar-links">
      ...
      <li>
        <a href="#"><span class="material-symbols-outlined"> flowchart </span>Bracket</a>
      </li>
      <li>
        <a href="#"><span class="material-symbols-outlined"> browse_activity </span>Tournament Information</a>
      </li>
      <li>
        <a href="#"><span class="material-symbols-outlined"> monitoring </span>Report</a>
      </li>
      <h4>
        <span>Account</span>
        <div class="menu-separator"></div>
    ...
    <div class="container2">
        <h1>Add Break</h1>
        <form action="add_break_details.php" method="POST">
